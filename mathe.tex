...
\begin{document}
	...
	\paragraph{d)}
	\begin{equation}
		e: \overrightarrow{x} = \left(\begin{array}{r} 3 \\ 2 \\ 1\end{array}\right) + \lambda \cdot \left(\begin{array}{r} 1 \\ 0 \\ 1\end{array}\right) + \mu \cdot \left(\begin{array}{r} 0 \\ 1 \\ 1\end{array}\right) \quad ; \quad g: \left(\begin{array}{r} 1 \\ 2 \\ 3\end{array}\right) + \lambda \cdot \left(\begin{array}{r} 1 \\ 1 \\ 2\end{array}\right)
	\end{equation}
